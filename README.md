...
| **mission-planner** | The Mission Planning tier above the robots — observes the fleet over ROS 2 | Started 2026-09-21: ROS 2 on the GPU workstation, receiving the hexapod's topics; no planner yet | [`projects/mission-planner/`](projects/mission-planner/AGENTS.md) (here) |
