...
| **SO-ARM101** | Standard Open Arm — LeRobot-compatible manipulator, built from the upstream design in its 12 V variant | Parts printed; all six servos commissioned and verified on one bus (2026-09-12); nothing assembled | [WayneKennedy/wk-soarm101](https://github.com/WayneKennedy/wk-soarm101) (public) · upstream [TheRobotStudio/SO-ARM100](https://github.com/TheRobotStudio/SO-ARM100) |
