...
| **wk-drone-bee35** | Aerial robot: 3.5" ducted cinewhoop on a SpeedyBee Bee35 Pro frame, built for position hold and endurance, not speed | Parts ordered 2026-09-11, nothing built. iNav first for a DJI-like hands-off loiter; ArduPilot and the mission-planning tier are a later evolution (its DEC-06) | [WayneKennedy/wk-drone-bee35](https://github.com/WayneKennedy/wk-drone-bee35) (private) |
