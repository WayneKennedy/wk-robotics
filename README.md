...
| **wk-drone-bee35** | Aerial robot: 3.5" ducted cinewhoop on a SpeedyBee Bee35 Pro frame, built for position hold and endurance, not speed | Parts ordered 2026-09-11, nothing built; firmware (iNav vs ArduPilot) open because it must be reachable from the mission-planning tier | [WayneKennedy/wk-drone-bee35](https://github.com/WayneKennedy/wk-drone-bee35) (private) |
