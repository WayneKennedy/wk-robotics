...
They were a D435i and a T265 ([`sourcing.md`](sourcing.md)): the D435i is the one the
hexapod later ran (owner, 2026-09-17), and the T265 is identified from its part number only.
Neither is on the tank now.
