...
|------|--------|---------|------|
| **Hardware** | Printable parts, mounts, mechanical design (`hardware/`) | CERN Open Hardware Licence v2 – Strongly Reciprocal | `CERN-OHL-S-2.0` |
...
**Note on the chassis:** the DFRobot Devastator platform is a **purchased third-party
product**, not a design carried in this repository. Nothing here relicenses it; the
